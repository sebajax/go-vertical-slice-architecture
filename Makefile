.PHONY: build-server start-server stop-server live-reload test test-coverage clean-deps format clean-imports lint vet check-shadow migrate-create migrate-up

# Define variable for migrations directory and PostgreSQL URL
